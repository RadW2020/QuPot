...
|---------|-----|-----------------|--------|
| API Gateway | http://localhost:3000 | NestJS | ⚠️ Scaffolded |
| Quantum Service | http://localhost:8002 | FastAPI, Qiskit | ✅ Functional |
| Lottery Service | http://localhost:3001 | NestJS, PostgreSQL | ⚠️ Scaffolded |
| Blockchain Service | http://localhost:3002 | NestJS, Solidity | ⚠️ Scaffolded |
| Auth Service | http://localhost:3003 | NestJS, JWT | ⚠️ Scaffolded |
